...
";
            var day10 = new Day10();
            Assert.Equal(4, day10.GetMaxSteps(inputData));
...
";
        ...
        private readonly string inputData = @"F-|-J7F7F7F-7F7F--7-L|-L7777.FFL-|.|.FF-FF7FFFFF7--F-J7.|-FF77|-F|777-F7.F7FF|-J7|-7.FFJ77FL.7-|-|7.|.77|-F-|-F|-FL.F77.FF-77|7.7--7--7FJ--7
...
LJJ..LL-JJ-L---7J-F77LL.LFJJLL-J-7JJ.L-LL7-L7.LLJL|JJF7-J-JLLJLLJ-7LJJ..LLJ-LJJ.LFL-FJJL|.FLLF-FL|LL.J.FL|-JJ.JJL--JLL--JJ.|J-L|J--J.L7..JJJ";
        ...
        [Fact]
        public void GetPart1AnswerTest()
        {
            var day10 = new Day10();
            Assert.Equal(10, day10.GetMaxSteps(inputData));
        }
    }
}
